...
The local database was SQLite. The chart in `../images/analytics-chart.png` uses the loaded temperature and precipitation values. It is a data chart, not an Airflow screenshot. PostgreSQL integration uses a separately labeled fixture in CI.
